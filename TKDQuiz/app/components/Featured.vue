...
export default {
  ...
  computed: {
    message() {
      ...
      <p>
        Esta aplicación ha sido desarrollada por Francis Meléndez Chaves, desarrollador Full-stack..
  ...
  methods: {
    ...
    openFace() {
      utils.openUrl('https://www.facebook.com/profile.php?id=100054609752257');
    }
  }
};
</script>
